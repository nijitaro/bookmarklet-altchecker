javascript:function altChecker(){
	a = document.getElementsByTagName('img');	var d = "";	var f = "";
	for(i=0;i<a.length;i  ){
		var b = a[i];		var fname = "　　" b.src.substring(b.src.lastIndexOf('/') 1,b.src.length);
		b.title = b.alt   fname  " (" b.width "×" b.height ")";
